...
# ==========================================
# الترجمة باستخدام Faster-Whisper (خفيف جداً على الرام)
# ==========================================
print("[*] Transcribing with Faster-Whisper (INT8 CPU Optimized)...")
...
print("\n[+] SUCCESS: Process completed flawlessly! [+]")
